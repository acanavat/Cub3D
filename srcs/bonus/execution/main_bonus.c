...
static void	init_sprite(void *mlx_instance, t_data *data, int id);
...
int	main(int argc, char **argv)
{
	...
	if (data->sprite)
		init_sprite(data->render.mlx_instance, data, 1);
...
static void	init_textures(void *mlx_instance, t_data *data)
{
	...
	data->door_open = open_image(
			mlx_instance, "asset/textures/pixelar.xpm", 64, 64);
	data->door_closed = open_image(mlx_instance,
			"asset/textures/pixelar.xpm", 64, 64);
...
/*
	sprite test code :
		set_sprite_size(data->sprite, 1, 4);
		add_sprite_frame(data->sprite, open_image(
				mlx_instance, "asset/textures/bk_floor.xpm", 64, 64));
		add_sprite_frame(data->sprite, open_image(
				mlx_instance, "asset/textures/pixelar.xpm", 64, 64));
		add_sprite_frame(data->sprite, open_image(
				mlx_instance, "asset/textures/old_pixelar.xpm", 64, 64));
		add_sprite_frame(data->sprite, open_image(
				mlx_instance, "asset/textures/old_old_pixelar.xpm", 64, 64));
*/
static void	init_sprite(void *mlx_instance, t_data *data, int id)
{
	int		i;
	...
	if (id == 1)
	{
		set_sprite_size(data->sprite, 1, 1);
		i = -1;
		while (++i <= 36)
		{
			path = ft_sprintf("asset/textures/gif/shark-%d.xpm", i);
			add_sprite_frame(data->sprite, open_image(
					mlx_instance, path, 310, 256));
			free(path);
		}
	}
}
