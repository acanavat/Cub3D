...
void	get_good_image_resolution(t_data *data, t_line *line_cast)
{
	...
	else if (data->map.tab_map
		[data->raycasting.map_x][data->raycasting.map_y] == MAP_DOOR_OPEN)
		get_image_resolution(&texture_width, &texture_height, data->door_open);
	else if (data->map.tab_map
		[data->raycasting.map_x][data->raycasting.map_y] == MAP_DOOR_CLOSED)
		get_image_resolution(
			&texture_width, &texture_height, data->door_closed);
